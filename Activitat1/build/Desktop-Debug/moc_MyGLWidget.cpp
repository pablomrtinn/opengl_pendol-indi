...
QT_MOC_LITERAL(5, 33, 13), // "setModeManual"
QT_MOC_LITERAL(6, 47, 8) // "esManual"

    },
    "MyGLWidget\0timeUpdate\0\0time\0tick\0"
    "setModeManual\0esManual"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->timeUpdate((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->tick(); break;
        case 2: _t->setModeManual((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::timeUpdate)) {
                *result = 0;
                return;
            }
        }
